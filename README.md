...
This DSL is much more expressive and intuitive. For web designers tasked with animation and choreographic considerations (instead of Javascript implementataions), the DSL is especially suitable as the DSL is embedded within the HTML markup **in close proximity** to the DOM elements that will transitioned.
